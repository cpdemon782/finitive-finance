...
const SUPPORT_EMAIL = 'affiliates@finitivefinance.app'
...
export function stageChangeEmail({
  ...
  const content = `
    ...
    <p style="color:#9a9080;font-size:13px;margin:0;">Questions? Reply to this email or contact us at <a href="mailto:${SUPPORT_EMAIL}" style="color:#c9a84c;">${SUPPORT_EMAIL}</a></p>
  `
...
export function supportEmail({
  ...
  return {
    subject: `Affiliate support — ${subject}`,
    html: baseTemplate(content),
  }
}
...
export function inviteEmail({
  ...
  const content = `
    ...
    <h1 style="color:#1a1610;font-size:22px;font-weight:600;margin:0 0 16px;">You've been invited to join Finitive Finance</h1>

    <p style="color:#5a5245;font-size:14px;line-height:1.7;margin:0 0 24px;">Hi ${inviteeName}, you've been personally invited by the Finitive Finance team to join our affiliate partner program.</p>
  ...
  return {
    subject: `You've been invited to join the Finitive Finance affiliate program`,
    html: baseTemplate(content),
  }
}
